...
# HABITAT -----
metadata <- read_metadata(here::here("data/2021-05_PtCloates_stereo-BRUVS/")) %>%
...
forwards <- read.delim("data/2021-05_PtCloates_stereo-BRUVS/2021-05_PtCloates_stereo_BRUVS_Forwards_Dot Point Measurements.txt", 
                       header = T, skip = 4, stringsAsFactors = FALSE, 
                       colClasses = "character", na.strings = "") %>%
  clean_names()

# read in forwards annotations
backwards <- read.delim("data/2021-05_PtCloates_stereo-BRUVS/2021-05_PtCloates_stereo_BRUVS_Backwards_Dot Point Measurements.txt", 
                       header = T, skip = 4, stringsAsFactors = FALSE, 
                       colClasses = "character", na.strings = "") %>%
  clean_names()
...
write_csv(tidy_habitat, "data/to upload/2021-05_PtCloates_stereo-BRUVS_benthos.csv")


# RELIEF ----
# read in forwards annotations
forwards_relief <- read.delim("data/2021-05_PtCloates_stereo-BRUVS/2021-05_PtCloates_stereo_BRUVS_Forwards_Relief_Dot Point Measurements.txt", 
                       header = T, skip = 4, stringsAsFactors = FALSE, 
                       colClasses = "character", na.strings = "") %>%
  clean_names()

# read in forwards annotations
backwards_relief <- read.delim("data/2021-05_PtCloates_stereo-BRUVS/2021-05_PtCloates_stereo_BRUVS_Backwards_Relief_Dot Point Measurements.txt", 
                        header = T, skip = 4, stringsAsFactors = FALSE, 
                        colClasses = "character", na.strings = "") %>%
  clean_names() 
...
write_csv(tidy_relief, "data/to upload/2021-05_PtCloates_stereo-BRUVS_relief.csv")
